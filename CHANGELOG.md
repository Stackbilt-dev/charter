...
- 28 new focused unit tests across `manifest.test.ts` (9), `merger.test.ts` (9), `evidence.test.ts` (10), and `content-classifier.test.ts` (15 added in Phase 2). Total: 243 tests across 20 test files (up from 215 in v0.5.0).
